...
\begin{figure}[H]
	\centering
	\subfloat[left image]{\includegraphics[width=0.4\textwidth]{img/calib0_left.jpg}}
	\subfloat[right image]{\includegraphics[width=0.4\textwidth]{img/calib0_right.jpg}}\\
	\subfloat[left image rectified]{\includegraphics[width=0.4\textwidth]{img/calib0_left_rect.jpg}}
	\subfloat[right image rectified]{\includegraphics[width=0.4\textwidth]{img/calib0_right_rect.jpg}}
